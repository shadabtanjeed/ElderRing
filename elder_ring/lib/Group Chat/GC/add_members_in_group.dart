...
class Add_Members_In_Group_Chat extends StatefulWidget {
  final String groupChatId, name;
  final List membersList;
  const Add_Members_In_Group_Chat(
      {required this.name,
...
class _AddMembersINGroupState extends State<Add_Members_In_Group_Chat> {
